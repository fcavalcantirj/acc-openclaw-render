...
# acc: seed-our-config wrapper (runs before the proxy; see seed-and-run.sh)
COPY seed-and-run.sh /usr/local/bin/seed-and-run.sh
...
CMD ["/usr/local/bin/seed-and-run.sh"]
